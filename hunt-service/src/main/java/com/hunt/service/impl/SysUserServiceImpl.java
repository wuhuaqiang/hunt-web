...
public class SysUserServiceImpl implements SysUserService {
    ...
    @Override
    public Integer insertUser(SysUser user, String jobIds, String permissionIds) {
        ...
        for (String jobid : jobIdArray) {
            ...
            userRoleOrganization.setSysRoleOrganizationId(Integer.valueOf(jobid));
        ...
        if (StringUtils.hasText(permissionIds)) {
            ...
            for (String permissionId : permissionIdArray) {
                ...
                userPermission.setSysPermissionId(Integer.valueOf(permissionId));
    ...
    @Override
    public boolean isExistLoginNameExcludeId(Integer id, String loginName) {
