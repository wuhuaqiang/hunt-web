...
public class BaseController {
    ...
    public boolean verifyCaptcha(HttpServletRequest request) throws Exception {
        ...
        int verifyResult = 0;
        GeetestLib gtSdk = new GeetestLib(systemService.selectDataItemByKey("geetest_id", 1), systemService.selectDataItemByKey("geetest_key", 1));
    ...
    public void exceptionHandler(HttpServletRequest request, HttpServletResponse response, Exception exception) throws IOException, ServletException {
      ...
      /*      if (systemService.selectDataItemByKey("error_detail", 2).equals("true")) {
            ...
            String basePath = systemService.selectDataItemByKey("basePath", 4);
